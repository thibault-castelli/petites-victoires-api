...
public class UpdatePostHandlerTests
{
    ...
    {
        _postRepository.GetByIdAsync(PostId.From(1), CancellationToken.None).Returns(ExistingPost(999));
    ...
    {
        _postRepository.GetByIdAsync(PostId.From(1), CancellationToken.None).Returns(ExistingPost(1));
