        ...
        Summary(s =>
        {
            ...
            s.ResponseExamples[200] = new ListPostsResponse(
                new List<PostRecord>
                {
                    ...
                    new(2, "example content", 2, "example2@mail.com", "example2", 0, DateTime.UtcNow)
                }, 1, 10, 2, 1);
            ...
            s.Params["sort_by"] = $"Allow sorting posts by {string.Join(", ", ListPostsValidator.AllowedPostsSorts)}.";
            s.Params["liked_by"] = "Filter posts only liked by this user id.";
            s.Params["created_by"] = "Filter posts only created by this user id.";
